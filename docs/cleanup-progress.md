...
| 4 — audited removal | **In progress** | The first candidate assessment retained `ciip/open_clip_train/transforms.py` because a fetched branch actively imports it. No candidate is approved and nothing has been removed. | Assess each candidate independently and rerun applicable compatibility baselines before approval. |
