...
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers, output_dim, heads, num_bands, input_resolution=224, width=64):
        super().__init__()
        self.output_dim = output_dim
        self.input_resolution = input_resolution

        # the 3-layer stem
        self.conv1 = nn.Conv2d(num_bands, width // 2, kernel_size=3, stride=2, padding=1, bias=False)
