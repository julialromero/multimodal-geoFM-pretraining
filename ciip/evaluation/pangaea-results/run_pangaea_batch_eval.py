    ...
    for dataset in DATASETS:
        for model in MODELS:
            for norm_key in NORMALIZATION_VARIANTS:
                ...
                result_key = (dataset.name, model.name, norm_key, preprocessing)
                if result_key in existing_results:
                    print(f"Skipping existing result: dataset={dataset.name}, model={model.name}, "
                ...
                print(f"\n\n------\n\nStarting experiment for model={model.name}, dataset={dataset.name}, normalization={norm_key}")
