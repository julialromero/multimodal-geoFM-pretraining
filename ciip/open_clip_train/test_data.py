...
class DummyDataset(Dataset):
    def __init__(self, num_samples=1000, img_size1=(3, 32, 32), img_size2=(12, 32, 32)):
...
def get_dummy_dataloader(batch_size=32, num_samples=1000, img_size1=(3, 32, 32), img_size2=(12, 32, 32)):
